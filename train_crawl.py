...
argument.add_argument('--fromcity','-f',default='beijingxi')
argument.add_argument('--tocity','-t',default='linfenxi')
...
# query_url='https://kyfw.12306.cn/otn/leftTicket/queryX?leftTicketDTO.train_date=2016-12-06&leftTicketDTO.from_station=BJP&leftTicketDTO.to_station=LXV&purpose_codes=ADULT'
